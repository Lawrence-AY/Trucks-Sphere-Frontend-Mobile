...
export default function OperatorSiteProfileScreen() {
  ...
  return (
    <PageShell>
      <CommandHeader eyebrow="Account" title="Profile" subtitle={`Site Operator · ${user?.displayName || 'User'}`} />
      <DataCard>
      ...
      <DataCard>
        ...
        <DetailRow icon="shield-checkmark-outline" label="Role" value={getRoleLabel('operator_site')} />
